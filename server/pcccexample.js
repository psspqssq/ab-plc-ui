...
conn.initiateConnection({ port: 44818, host: '192.168.0.20'/*, routing: [0x01, 0x00, 0x01, 0x00] }*/ }, connected);
...
function connected(err) {
    ...
    conn.writeItems('TEST10', 1, valuesWritten);  // You can write a single array item too.  
